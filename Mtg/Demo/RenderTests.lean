...
#guard mentions (header proposedTitania) "choose an additional cost (CR 601.2b"
#guard mentions (header titaniaPaidDiscard) "discard a card as an additional cost"
